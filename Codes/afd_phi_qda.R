...
# résultats déjà plus lisibles
# Avec la méthode qda, pour prendre 10% de risque de mal classer une ferme défaillante, il faudrait 
# prendre un seuil de 0.2
